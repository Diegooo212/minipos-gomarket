...
export async function insertarDatosIniciales(db: Database) {
  ...
  if (check[0].count > 0) return; // Ya tiene datos, no insertar nada
  ...
  await db.execute(`
    ...
    ('Jabón Líquido',         '7805678',  2890, 1500, 15, 5,  5, 'unidad'),
